...
class AppStore extends Component {
  ...
  getFilteredApps = () => {
    ...
    const filteredApps = appsList.filter(
      eachApp => activeTabId === eachApp.category,
    )
    return filteredApps
  }
  ...
  render() {
    ...
    const matchedApps = filteredApps.filter(eachFilterApp =>
      eachFilterApp.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
    return (
